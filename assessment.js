...
function test() {
  ...
  // ここにテストを追加
  console.assert(assessment('太郎') === assessment('太郎'), '同じ名前なら同じ診断結果を出力する処理が正しくありません。');
  console.assert(assessment('次郎') === assessment('次郎'), '同じ名前なら同じ診断結果を出力する処理が正しくありません。');
  console.assert(assessment('花子') === assessment('花子'), '同じ名前なら同じ診断結果を出力する処理が正しくありません。');
